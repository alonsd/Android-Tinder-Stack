...
public class TinderCardView extends FrameLayout implements View.OnTouchListener {
    ...
    // region Constructors
    public TinderCardView(Context context, Completion completion) {
        super(context);
        this.completion = completion;
        init(context, null);
    }

    public TinderCardView(Context context, AttributeSet attrs, Completion completion) {
        super(context, attrs);
        this.completion = completion;
        init(context, attrs);
    }

    public TinderCardView(Context context, AttributeSet attrs, int defStyle, Completion completion) {
            ...
            switch(motionEvent.getAction()){
                ...
                case MotionEvent.ACTION_UP:
                    if(isCardBeyondLeftBoundary(view)){
                        ...
                        completion.send(new TopCardMovedEvent(-(screenWidth)));
